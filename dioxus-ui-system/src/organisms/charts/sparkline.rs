...
pub fn Sparkline(props: SparklineProps) -> Element {
    ...
    let fill_css = props
        ...
        .as_ref()
        .map(|c| c.to_rgba())
        .unwrap_or_else(|| format!("rgba({}, {}, {}, 0.2)", color.r, color.g, color.b));
...
pub fn TrendIndicator(
    data: Vec<f64>,
    #[props(default)] current_value: Option<f64>,
    #[props(default = "120px".to_string())] width: String,
    #[props(default = "40px".to_string())] height: String,
    #[props(default)] variant: SparklineVariant,
    #[props(default)] color: Option<Color>,
